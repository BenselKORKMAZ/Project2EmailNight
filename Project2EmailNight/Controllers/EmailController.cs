...
namespace Project2EmailNight.Controllers
{
    public class EmailController : Controller
    {
        ...
        public IActionResult SendEmail(MailRequestDto mailRequestDto)
        {
            ...
            MailboxAddress mailboxAddressFrom = new MailboxAddress("Identity Admin", "benselkorkmaz@gmail.com");
            ...
            smtpClient.Authenticate("benselkorkmaz@gmail.com", "yigz mxxg lgob oydn");
